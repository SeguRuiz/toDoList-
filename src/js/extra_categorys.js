...
//recorre el array de los divs de cada tarea en pantalla
      if (category.category != tagCategory && category.id == divTask.id) {
//Si la categoria en de la tarea en el servidor es diferente a la categoria seleccionada
//y el id de esa tarea es igual al id de su div (para agarrar el div de esa tarea en especifico)
...
//Asi cada tarea podra seleccionar las categorias disponibles
    });
